...
export const products: Product[] = [
  { id: 'p1', sku: 'WW-001', name: 'Wai Wai Vegetable Instant Noodles', description: 'Nepal’s favourite ready-in-2-minutes instant noodles with the classic vegetable masala and a crunchy fry. Great for a quick snack or light meal.', brand: 'Wai Wai', category: 'Chips & Snacks', categoryGroup: 'Snacks & Drinks', image: img('noodles'), price: 35, mrp: 40, unit: '84g', stock: 320, lowStockThreshold: 30, shelfNo: 'A-3', onClearance: false, active: true, status: 'active', deliveryMins: 15, sold: 1240 },
  { id: 'p2', sku: 'NO-101', name: "Nature's Pure Sunflower Oil 1L", description: 'Light, heart-friendly refined sunflower oil rich in Vitamin E. Ideal for everyday frying, sautéing and deep-frying with a neutral taste.', brand: "Nature's", category: 'Cooking Oil', categoryGroup: 'Grocery & Kitchen', image: img('oil'), price: 385, mrp: 420, unit: '1L', stock: 96, lowStockThreshold: 15, shelfNo: 'C-1', onClearance: false, active: true, status: 'active', deliveryMins: 12, sold: 540 },
  { id: 'p3', sku: 'HR-201', name: 'Heritage Select Premium Basmati Rice 1kg', description: 'Long-grain aged basmati rice with a delicate aroma that fluffs up beautifully. Perfect for biryani, pulao and festive meals.', brand: 'Heritage', category: 'Rice', categoryGroup: 'Grocery & Kitchen', image: img('rice'), price: 249, mrp: 280, unit: '1kg', stock: 58, lowStockThreshold: 15, shelfNo: 'C-2', onClearance: false, active: true, status: 'active', deliveryMins: 12, sold: 410 },
  { id: 'p4', sku: 'NU-310', name: 'Choco Delight Chocolate Drink Powder 500g', description: 'Malted chocolate health drink powder packed with vitamins and minerals. Mix with hot or cold milk for a rich, energising treat kids love.', brand: 'Nutri', category: 'Milk & Health Drinks', categoryGroup: 'Snacks & Drinks', image: img('choco'), price: 495, mrp: 550, unit: '500g', stock: 12, lowStockThreshold: 15, shelfNo: 'D-4', onClearance: false, active: true, status: 'low_stock', deliveryMins: 15, sold: 220 },
  { id: 'p5', sku: 'HB-205', name: 'Heritage Select Digestive Biscuits 400g', description: 'Wholewheat digestive biscuits with a lightly sweet, crumbly bite. A wholesome companion for tea or coffee any time of day.', brand: 'Heritage', category: 'Biscuits & Cookies', categoryGroup: 'Snacks & Drinks', image: img('biscuit'), price: 185, mrp: 200, unit: '400g', stock: 140, lowStockThreshold: 20, shelfNo: 'B-5', onClearance: false, active: true, status: 'active', deliveryMins: 15, sold: 360 },
  { id: 'p6', sku: 'NJ-410', name: "Nature's Pride Mixed Fruit Juice 1L", description: 'Refreshing mixed-fruit juice made from real fruit pulp with no added preservatives. Best served chilled.', brand: "Nature's", category: 'Soft Drinks & Juices', categoryGroup: 'Snacks & Drinks', image: img('juice'), price: 225, mrp: 250, unit: '1L', stock: 0, lowStockThreshold: 15, shelfNo: 'D-1', onClearance: false, active: false, status: 'out_of_stock', deliveryMins: 12, sold: 180 },
  { id: 'p7', sku: 'GM-150', name: 'Gokul Full Cream Milk 500ml', description: 'Farm-fresh full cream milk, pasteurised and homogenised for a rich, creamy taste. Perfect for tea, coffee and daily nutrition.', brand: 'Gokul', category: 'Milk & Health Drinks', categoryGroup: 'Snacks & Drinks', image: img('milk'), price: 35, mrp: 38, unit: '500ml', stock: 210, lowStockThreshold: 40, shelfNo: 'F-2', onClearance: false, active: true, status: 'active', deliveryMins: 10, sold: 980 },
  { id: 'p8', sku: 'TK-220', name: 'Tokla Premium Tea 200g', description: 'Premium CTC black tea with a strong, full-bodied flavour and rich colour. Brews the perfect cup of Nepali milk tea.', brand: 'Tokla', category: 'Tea & Coffee', categoryGroup: 'Grocery & Kitchen', image: img('tea'), price: 145, mrp: 160, unit: '200g', stock: 74, lowStockThreshold: 15, shelfNo: 'B-1', onClearance: true, active: true, status: 'active', deliveryMins: 12, sold: 300 },
  { id: 'p9', sku: 'MD-130', name: 'Mustang Daal Masino 1kg', description: 'Premium polished masino daal (red lentils) that cooks quickly into a smooth, protein-rich dal. A staple for every Nepali kitchen.', brand: 'Mustang', category: 'Daal & Pulses', categoryGroup: 'Grocery & Kitchen', image: img('daal'), price: 175, mrp: 190, unit: '1kg', stock: 41, lowStockThreshold: 15, shelfNo: 'C-3', onClearance: false, active: true, status: 'active', deliveryMins: 12, sold: 260 },
  { id: 'p10', sku: 'CK-330', name: 'Current Tomato Ketchup 500g', description: 'Thick, tangy tomato ketchup made from ripe tomatoes. The perfect dip for momos, fries, pakauda and snacks.', brand: 'Current', category: 'Frozen & Canned', categoryGroup: 'Grocery & Kitchen', image: img('ketchup'), price: 165, mrp: 180, unit: '500g', stock: 9, lowStockThreshold: 15, shelfNo: 'B-7', onClearance: false, active: true, status: 'low_stock', deliveryMins: 15, sold: 150 },
  { id: 'p11', sku: 'LY-140', name: 'Lays Classic Salted Chips 52g', description: 'Crispy potato chips with just the right amount of salt. The all-time-favourite crunchy snack for any moment.', brand: 'Lays', category: 'Chips & Snacks', categoryGroup: 'Snacks & Drinks', image: img('chips'), price: 65, mrp: 70, unit: '52g', stock: 188, lowStockThreshold: 30, shelfNo: 'A-1', onClearance: false, active: true, status: 'active', deliveryMins: 10, sold: 720 },
  { id: 'p12', sku: 'CC-160', name: 'Coca-Cola 1.25L', description: 'The classic refreshing cola in a shareable 1.25L bottle. Best served ice-cold with friends and family.', brand: 'Coca-Cola', category: 'Soft Drinks & Juices', categoryGroup: 'Snacks & Drinks', image: img('coke'), price: 130, mrp: 140, unit: '1.25L', stock: 132, lowStockThreshold: 24, shelfNo: 'F-1', onClearance: false, active: true, status: 'active', deliveryMins: 10, sold: 610 },
]
